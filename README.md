...
✅<b>Версия</b><br />
Бот 1.0.1 (перезагрузка проекта) от 07.09.2024г.<br />
Python 3.12.2 <br />
...
⚡Исправления.   
Перезагрузка проекта.  02/09/2024  
Добавление проверок для контроля добавления новых слов пользователем. 07/09/2024  
